...
#ifndef CLIENTPEER_H_
#define CLIENTPEER_H_
 ...
 * - sends data to server peer
 */
class ClientPeerHalfDuplexPlainOut : public PeerBase {
private:
	//owned:
...
public:
	ClientPeerHalfDuplexPlainOut(const PeerBaseParams& params);
	virtual ~ClientPeerHalfDuplexPlainOut();
